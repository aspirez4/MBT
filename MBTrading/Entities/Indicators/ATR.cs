...
namespace MBTrading.Entities.Indicators
{
    public class ATR : Indicator
    {
        ...
        private double GetTR(Candle cCurrCandle, Candle cPrevCandle)
        {
        ...
        public void UpdateIndicatorValue()
        {
            ...
            this.TR_Value = ((this.TR_Dec * (this.Length - 1)) +
            ...
            this.LongValue = this.dHighestHigh - (this.TR_Value * this.Multiplier);
            this.ShortValue = this.dLowestLow + (this.TR_Value * this.Multiplier);
        }
